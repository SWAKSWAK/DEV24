	        ...
	        <div id="content">
	            ...
	            <form id="f_writeForm">
	                <table class="table" border="1">
	                    ...
	                    <tr>
	                        <th>작성자</th>
	                        <td class="td_nickname">닉넴</td>
	                    </tr>
	                    <tr>
	                        <th>리뷰내용</th>
	                        <td><textarea id="re_content" name="re_content" rows="20" cols="100" class="form-control"></textarea></td>
	                    </tr>
	                    <tr>
	                    	<th>이미지첨부</th>
	                    	<td>
	                    		<input type="file" name="re_imgurl" id="re_imgurl" class="form-control" />
	                    	</td>
	                    </tr>
	                </table>
	            </form>
